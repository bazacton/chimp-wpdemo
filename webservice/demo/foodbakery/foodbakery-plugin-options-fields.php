                ...
                if (isset($value['type'])){
                    switch ($value['type']) {
                        ...
                        case "sub-heading":
                            ...
                            $foodbakery_opt_array = array(
                                'name' => $value['name'],
                                'title2' => esc_html('De-register Purchase Code', 'foodbakery'),
                                'title2class' => 'foodbakery-dereg-code-area foodbakery-dereg-btn',
                        ...
                        case "upload":
                            ...
                            $output .= '<div class="icon-image-browse-field">';
